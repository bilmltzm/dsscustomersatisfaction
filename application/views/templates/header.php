...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container">
<a class="navbar-brand" href="<?=base_url(); ?>" ><img class="logo" src="<?=base_url(); ?>./img/logo.png" height="28px;" padding="2px 10px;"></a> 
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url();?>Alternatif">Data Alternatif</a>
      </li>
      <li class="nav-item">
